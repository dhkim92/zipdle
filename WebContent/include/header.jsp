...
<nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom border-info">
  ...
  <a class="navbar-brand mx-5" href="/zipdlee/main.do">
  <b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ZipdelE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></a>
  </c:if>
  ...
  <div class="collapse navbar-collapse text-center" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item mr-3">
        <a class="nav-link" href="/community/reform.do">Community</a>
      </li>
      <li class="nav-item mr-3">
    ...
    <c:if test="${sessionScope.login}">  
      <li class="nav-item  mr-3 dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="/mypage/itlist.do">내 견적</a>
     ...
     <c:if test="${not sessionScope.login}">
     	 <li class="nav-item  mr-3">
    	<a class="nav-link dropdown-toggle" href="/mypage/result/notLogin.jsp">
          My Page
        </a>
     	 </li>
