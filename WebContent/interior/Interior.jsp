			...
			<div class="container-fluid mt-3 bg-light">
				...
				<div class="container clearfix" id="spaceinfo">
					...
					<div class="row mt-5 d-flex justify-content-between">
						...
						<div>
							<a href="/interior/drag.do" class="btn btn-warning">인테리어 설계 직접 해보기!</a>
						</div>
						<!-- end of 첨부파일 -->
					...
					<div class="container mt-2 border-top justify-content-center">
						...
						<div>
							...
							<div class="input-group mb-3 mt-5">
								...
								<input type="text" class="form-control"
									placeholder="제목을 입력해주세요" id="intName" name="intName" required="required">
						...
						<div>
							<div class="input-group">
								...
								<textarea rows="10" id="content" class="form-control" aria-label="With textarea"
									placeholder="견적 관련 요청 사항을 적어주세요" name="content"></textarea>
						...
						<div class="input-group mb-3 mt-5">
								...
								<input type="text" class="form-control"
									placeholder="원하는 견적 금액을 입력해주세요" id="intPrice" name="intPrice" size="2rem" required="required">
						</div>
				...
				<div class="row mt-2 mb-5 d-flex justify-content-center clearfix">
					
						<button id="btnWrite" class="btn btn-warning text-center mb-2">신청 하기</button>
