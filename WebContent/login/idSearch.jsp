  ...
  <div class="py-5">
    <div class="container">
      <div class="row w-75 mx-auto">
        <div class="col-md-12">
          <form class="w-75 mx-auto" action="/login/idsearch.do" method="post">
            
            <div class="form-group">
              <label><b>이름</b></label>
              <input type="text" name="name" class="form-control" placeholder="Name" required  maxlength="10"> </div>
            ...
            <button id="idSerchBt" type="submit" class="btn btn-primary btn-block btn-lg mx-auto w-50">
              <b>ID 찾기</b>
            </button>
          </form>
        </div>
