...
<button type="button" id="pwsearchBtn" style="display: none;"class="btn btn-primary" 
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modaltitle"><b>비밀번호 수정 결과</b></h5>
      </div>
...
<c:if test="${requestScope.pwsearch }">
...
<c:if test="${not requestScope.pwsearch }">
<div class="modal-body">
