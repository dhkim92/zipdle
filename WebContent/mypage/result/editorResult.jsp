  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="modaltitle"><b>에디터 신청 결과</b></h4>
      </div>
...
<c:if test="${requestScope.editorResult }">
<div class="modal-body">
        
        	<h5>신청이 정상으로 처리되었습니다.</h5>
        	<br>
			관리자 승인후 에디터 활동이 가능합니다.
			<br>
			감사합니다^^
...
<c:if test="${requestScope.editorResult == false }"> 
<div class="modal-body">
        
        	<h5>에디터 신청에 실패하였습니다.</h5>
        	<br>
			입력하신 정보를 다시 확인 해주세요!
