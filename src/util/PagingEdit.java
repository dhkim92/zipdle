...
public class PagingEdit {
	...
	//	pageCount == 10
	//	listCount == 10
	public PagingEdit(int totalCount) {
	...
	//	pageCount == 10
	//	listCount == 10
	public PagingEdit(int totalCount, int curPage) {
		this(totalCount);
	...
	//	listCount == 10
	public PagingEdit(int totalCount, int curPage, int listCount) {
		this.setTotalCount(totalCount);
		this.setCurPage(curPage);
	...
	//	listCount == 10
	public PagingEdit(int totalCount, int curPage, int listCount, int pageCount) {
		this.setTotalCount(totalCount);
		this.setCurPage(curPage);
	...
	private void makePaging() {
		...
		if(pageCount == 0)	setPageCount(9); //한 화면에 보이는 페이지수 기본값(10) 세팅
		if(listCount == 0)	setListCount(9); //한 화면에 보이는 게시글수 기본값(10) 세팅
